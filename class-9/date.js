...
// console.log(differenceTimeMs); // 3600000 = 1hr
...
const currDate = new Date();
const dobDate = new Date("2002-07-14");

const diffInMs = currDate.getTime() - dobDate.getTime();
const oneDay = 24 * 60 * 60 * 1000; // Hours * Minutes * Seconds * Miliseconds
const diffInDays = Math.floor(diffInMs / oneDay); // 8102 days

// console.log(
//   `The difference between the current date and your DOB is ${diffInDays} days.`
// );
...
const newDay = currentDate.getDate() + 10;
currentDate.setDate(newDay);

console.log(
  `The current date plus 10 days is ${currentDate.toLocaleDateString()}`
); // The current date plus 10 days is 9/28/2024
